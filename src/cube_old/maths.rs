...
pub fn mat_mult(m2: Vec<Vec<f32>>, m1: Vec<Vec<f32>>) -> Vec<Vec<f32>> {
...
pub fn perspective(dist: f32, z: f32) -> Vec<Vec<f32>> {
    let psp = 1. / (dist - z) ;
